...
export default function Portfolio() {
    ...
    useEffect(() => {
        Promise.all([
            ...
            fetch(`https://api.github.com/users/${CONFIG.github}/repos?sort=updated&per_page=50`)
        ])
            .then(async ([userRes, reposRes]) => {
                const [userData, reposData] = await Promise.all([userRes.json(), reposRes.json()]);
                if (userData?.avatar_url) {
                    setAvatarUrl(`${userData.avatar_url}?s=460`);
                }
                ...
                <div className="text-center max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                        <a
                            ...
                            download
                            className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 font-bold rounded-2xl shadow-2xl hover:scale-105 transition-all duration-300 flex items-center space-x-3"
                        >
                            <Download size={24} />
                        ...
                        <a
                            ...
                            className="px-8 py-4 border-2 border-white/20 hover:border-blue-500/50 rounded-2xl hover:bg-white/5 transition-all duration-300 flex items-center space-x-3"
                        >
                            <Github size={24} />
                        ...
                        {[
                            ...
                            return (
                                <a
                                    ...
                                    className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-blue-500/30 transition-all duration-500 hover:scale-105 text-center block"
                                >
